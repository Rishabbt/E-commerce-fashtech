        ...
        try{
            ...
            if (['approved', 'rejected', 'pending'].includes(data.status)){
                ...
                switch (data.status){
                    ...
                    break
                    case "rejected":
                        setMessage("Your store has been rejected, contact the admin for more detail")
                    break
                    case "pending":
                        setMessage("Your store has been pending, please wait for the admin to approve your store")
                    break   
                    default:
                    break         
                }
