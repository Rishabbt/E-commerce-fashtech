...
const CategoriesMarquee = () => {
    ...
    return (
        <div className="overflow-hidden w-full relative max-w-7xl mx-auto select-none group sm:my-20">
            ...
            <div className="flex min-w-[200%] animate-[marqueeScroll_10s_linear_infinite] sm:animate-[marqueeScroll_10s_linear_infinite] group-hover:[animation-play-state:paused] gap-4" >
