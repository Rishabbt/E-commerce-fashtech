...
export const categories = ["Headphones","Security Camera","Smart watch", "Speakers", "Watch", "Earbuds", "Mouse", "Decoration","iPad","Apple Burds","Home projector","Shoes","MacBook Air","IPhone",];
...
export const productDummyData = [
    ...
    {
        id: "prod_5",
        name: "Boat Smart Speaker",
        description: "The boAt Stone 1200 delivers rich, immersive sound with its 14 W boAt Signature Sound and dual full-range drivers, making it perfect for living rooms or home parties. boAt Lifestyle With an IPX7 water-resistant build, you can confidently use it poolside or outdoors without worry. Boat Lifestyle Support It supports multi-mode connectivity—Bluetooth 5.0, AUX, USB, FM—and even voice-assistant commands for Google & Siri for seamless smart controls. CromaFeaturing up to 9 hours of battery life and RGB LED lighting to set the vibe, this speaker blends performance with style. If you like, I can provide a full 8-10 line product-description with key specs highlighted.",
        mrp: 2500,
        price: 2099,
        images: [product_img5],
        storeId: "seller_1",
